...
export declare type DeepPartial<T> = T extends PartialMarker<infer PT> ? T[typeof asPartial] : T extends Decimal ? T : T extends GuardedMap<infer K, infer V> ? T : T extends Map<infer K, infer V> ? Map<DeepPartial<K>, DeepPartial<V>> : T extends Set<infer V> ? Set<DeepPartial<V>> : T extends (infer V)[] ? DeepPartial<V>[] : DeepPartialObject<T>;
